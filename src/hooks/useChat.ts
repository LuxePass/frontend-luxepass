...
const whatsappBackendBaseUrl = process.env.NEXT_PUBLIC_WHATSAPP_BACKEND_URL;
if (!whatsappBackendBaseUrl) {
	throw new Error("NEXT_PUBLIC_WHATSAPP_BACKEND_URL is required");
}
